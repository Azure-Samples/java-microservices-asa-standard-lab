---
lab:
    Title: 'Lab 02: Migrate a Spring Apps application to Azure'
...
- Test the application through the publicly available endpoints
   ...
   {: .note }
   > Follow the steps in the [install instructions](../../../install.md) to set up this lab on your platform of choice.
